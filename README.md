...
This project implements a simple Tech Adapter for Amazon Athena.
...
Amazon Athena is an interactive query service that makes possible to analyze data directly in Amazon Simple Storage Service (Amazon S3) using standard SQL.

Learn more on [Amazon Athena official documentation](https://docs.aws.amazon.com/athena/).
